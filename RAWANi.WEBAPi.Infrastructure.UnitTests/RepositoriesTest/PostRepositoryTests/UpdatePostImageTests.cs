...
{
    public class UpdatePostImageTests
    {
        ...
        [Fact]
        public async Task UpdatePostImageAsync_ValidPost_ReturnsSuccess()
        {
            // Arrange
            var post = Post.Create(Guid.NewGuid(), Guid.NewGuid(), "Valid Title", "Valid Content", "https://example.com").Data;
            post.UpdatePostImage("https://newimage.com");
        ...
        [Fact]
        public async Task UpdatePostImageAsync_NoRowsAffected_ReturnsFailure()
        {
            // Arrange
            var post = Post.Create(Guid.NewGuid(), Guid.NewGuid(), "Valid Title", "Valid Content", "https://example.com").Data;
            post.UpdatePostImage("https://newimage.com");
        ...
        [Fact]
        public async Task UpdatePostImageAsync_CancelledOperation_ReturnsCancellationHandled()
        {
            // Arrange
            var post = Post.Create(Guid.NewGuid(), Guid.NewGuid(), "Valid Title", "Valid Content", "https://example.com").Data;
            post.UpdatePostImage("https://newimage.com");
        ...
        [Fact]
        public async Task UpdatePostImageAsync_ExceptionOccurs_ReturnsFailure()
        {
            // Arrange
            var post = Post.Create(Guid.NewGuid(), Guid.NewGuid(), "Valid Title", "Valid Content", "https://example.com").Data;
            post.UpdatePostImage("https://newimage.com");
