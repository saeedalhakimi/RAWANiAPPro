...
{
    public class IsUserProfileExistsTests
    {
        ...
        public IsUserProfileExistsTests()
        {
            ...
            _mockDbCommand.Setup(c => c.ExecuteScalarAsync(It.IsAny<CancellationToken>()))
                          .ReturnsAsync(1); // Simulate profile exists
        ...
        [Fact]
        public async Task IsUserProfileExistsAsync_UserProfileExists_ReturnsTrue()
        {
            // Arrange
            ...
            // Act
            var result = await _postRepository.IsUserProfileExistsAsync(userProfileId, cancellationToken);
        ...
        [Fact]
        public async Task IsUserProfileExistsAsync_UserProfileDoesNotExist_ReturnsFalse()
        {
            // Arrange
            var userProfileId = Guid.NewGuid();
            var cancellationToken = new CancellationToken();
            ...
            _mockDbCommand.Setup(c => c.ExecuteScalarAsync(It.IsAny<CancellationToken>()))
                          .ReturnsAsync(0); // Simulate profile does not exist
        ...
        [Fact]
        public async Task IsUserProfileExistsAsync_CancelledOperation_ReturnsCancellationHandled()
        {
            // Arrange
            var userProfileId = Guid.NewGuid();
        ...
        [Fact]
        public async Task IsUserProfileExistsAsync_ExceptionOccurs_ReturnsFailure()
        {
            // Arrange
            var userProfileId = Guid.NewGuid();
            var cancellationToken = new CancellationToken();
