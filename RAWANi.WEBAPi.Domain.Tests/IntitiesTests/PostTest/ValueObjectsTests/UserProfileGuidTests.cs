...
{
    public class UserProfileGuidTests
    {
        [Fact]
        public void Create_WithValidGuid_ReturnsSuccess()
        {
            ...
            // Act
            var result = UserProfileGuid.Create(validGuid);
        ...
        public void Create_WithEmptyGuid_ReturnsFailure()
        {
            ...
            // Act
            var result = UserProfileGuid.Create(emptyGuid);
            ...
            Assert.Contains("User profile Id cannot be empty.", result.Errors.First().Details);
        }
        ...
        public void Equals_WithSameGuid_ReturnsTrue()
        {
            ...
            var result1 = UserProfileGuid.Create(guid);
            var result2 = UserProfileGuid.Create(guid);
        ...
        {
            // Arrange
            var result1 = UserProfileGuid.Create(Guid.NewGuid());
            var result2 = UserProfileGuid.Create(Guid.NewGuid());
        ...
        public void GetHashCode_ReturnsGuidHashCode()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var result = UserProfileGuid.Create(guid);
        ...
        public void ImplicitConversion_ToGuid_ReturnsGuid()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var postGuid = UserProfileGuid.Create(guid);
        ...
        public void EqualityOperator_WithSameGuid_ReturnsTrue()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var postGuid1 = UserProfileGuid.Create(guid);
            var postGuid2 = UserProfileGuid.Create(guid);
        ...
        {
            // Arrange
            var postGuid1 = UserProfileGuid.Create(Guid.NewGuid());
            var postGuid2 = UserProfileGuid.Create(Guid.NewGuid());
