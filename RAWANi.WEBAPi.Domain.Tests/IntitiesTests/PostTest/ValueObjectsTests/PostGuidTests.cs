...
namespace RAWANi.WEBAPi.Domain.UnitTests.IntitiesTests.PostTest.ValueObjectsTests
{
    public class PostGuidTests
    {
        ...
        public void Create_WithValidGuid_ReturnsSuccess()
        {
            ...
            // Act
            var result = PostGuid.Create(validGuid);
        ...
        public void Create_WithEmptyGuid_ReturnsFailure()
        {
            ...
            // Act
            var result = PostGuid.Create(emptyGuid);
            ...
            Assert.Contains("Post Id cannot be empty.", result.Errors.First().Details);
        }
        ...
        public void Equals_WithSameGuid_ReturnsTrue()
        {
            ...
            var result1 = PostGuid.Create(guid);
            var result2 = PostGuid.Create(guid);
        ...
        {
            // Arrange
            var result1 = PostGuid.Create(Guid.NewGuid());
            var result2 = PostGuid.Create(Guid.NewGuid());
        ...
        public void GetHashCode_ReturnsGuidHashCode()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var result = PostGuid.Create(guid);
        ...
        public void ImplicitConversion_ToGuid_ReturnsGuid()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var postGuid = PostGuid.Create(guid);
        ...
        public void EqualityOperator_WithSameGuid_ReturnsTrue()
        {
            // Arrange
            var guid = Guid.NewGuid();
            var postGuid1 = PostGuid.Create(guid);
            var postGuid2 = PostGuid.Create(guid);
        ...
        {
            // Arrange
            var postGuid1 = PostGuid.Create(Guid.NewGuid());
            var postGuid2 = PostGuid.Create(Guid.NewGuid());
